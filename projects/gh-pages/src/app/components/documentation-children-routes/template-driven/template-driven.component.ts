...
export class TemplateDrivenComponent implements OnInit {
 ...
 <option value="3">Third option</option>
  ...
  controlDirectiveWithCVAExampleCode = `<control-value-accessor [ui2qpControl]="{qpName:'customOptions', type:'string-array'}>
  ...
  fullExampleCode = {
    html: `// Custom component example
      ...
      // Input without ControlValueAccessor
      <mat-form-field>
      ...
      // Native input without ControlValueAccessor. Approach about can also be used here
      <mat-form-field>
